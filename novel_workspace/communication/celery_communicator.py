...
class CeleryCommunicator:
    """ CeleryCommunicator class for managing communication with Celery. """
    celery_app = app
    ...
    def send_message(self, sender_id, receiver_id, content):
        ...
        # 发送消息：将消息作为参数传递给 Celery 应用的 send_task 方法，并指定任务名称。
        # 根据接受者的 ID，选择合适的 Celery 任务，如；
        # manager: 
        # 
        self.celery_app.send_task('tasks.expert_task', args=[message.to_json()])
